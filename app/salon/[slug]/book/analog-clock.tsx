 ...
 * selected time and the numbers are clickable shortcuts to the nearest hour.
 */
        ...
        return (
          <text
            ...
            className={cn(
              ...
              available ? "cursor-pointer fill-foreground" : "fill-muted-foreground/50",
